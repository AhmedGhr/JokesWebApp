...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View("Index",await _context.Joke.Where(j=>j.JokeAnswer.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuote,JokeAnswer")] Joke joke)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuote,JokeAnswer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
